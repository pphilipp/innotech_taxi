...
/**
 * Created by Sergey on 25.07.2015.
 */
public class OnSwipeDetector implements View.OnTouchListener {
    ...
    public OnSwipeDetector setMinDistanceInPixels(int min_distance)
    {
